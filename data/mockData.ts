...
export const TALENTS: Talent[] = [
  ...
  },
  {
    ...
    portfolio: [{ type: 'image', url: 'https://picsum.photos/seed/photo1/400/600' }],
  ...
  },
  {
    ...
    portfolio: [{ type: 'image', url: 'https://picsum.photos/seed/cake1/400/600' }],
  ...
  ...Array.from({ length: 30 }, (_, i) => {
      ...
      const professions = [
        ['Yoga Instructor', 'Wellness', 'Meditation'],
        ['Web Developer', 'Frontend', 'Backend', 'React'],
        ['Electrician', 'Home Wiring', 'Repairs'],
        ['Dog Walker', 'Pet Sitter'],
        ['Translator', 'English-isiZulu', 'Documents'],
        ['Event Security', 'Bouncer', 'Crowd Control'],
        ['Barista', 'Specialty Coffee'],
        ['Videographer', 'Drone Pilot', 'Wedding Videos'],
        ['Painter', 'Home Painting', 'Art Commission'],
        ['Musician', 'Guitarist', 'Singer', 'Live Music'],
        ['Accountant', 'Tax Returns', 'Bookkeeping'],
        ['Baker', 'Artisan Bread', 'Pastries'],
        ['Cleaner', 'Home Cleaning', 'Office Cleaning'],
        ['Florist', 'Wedding Flowers', 'Bouquets'],
        ['Mechanic', 'Car Service', 'Repairs'],
        ['Animator', '2D Animation', 'Motion Graphics'],
        ['Locksmith', 'Key Cutting', 'Emergency Locksmith'],
        ['Tailor', 'Alterations', 'Custom Suits'],
        ['Life Coach', 'Career Coaching', 'Personal Growth'],
        ['Driving Instructor', 'K53', 'Learners License'],
        ['Consultant', 'Business Strategy'],
        ['Architect', 'Building Plans', 'Renovations'],
        ['Lawyer', 'Legal Advice', 'Contracts'],
        ['Babysitter', 'Childcare'],
        ['Nutritionist', 'Meal Plans', 'Dietary Advice'],
        ['Copywriter', 'Marketing Copy', 'Content Writing'],
        ['Podcaster', 'Audio Editing', 'Show Host'],
        ['Travel Agent', 'Holiday Packages', 'Flights'],
        ['Real Estate Agent', 'Property Sales', 'Rentals'],
        ['Event MC', 'Host', 'Public Speaking'],
      ];
      ...
      return {
        ...
        distance: 2 + (i * 3) % 28,
        hustles: selectedProfession,
        bio: `A passionate and reliable ${selectedProfession[0]} looking for new opportunities.`,
